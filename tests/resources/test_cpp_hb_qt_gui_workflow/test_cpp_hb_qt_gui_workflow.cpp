...
#include "test_cpp_hb_qt_gui_workflow.hpp"
...
: QWidget() {
    ...
    this->settings = new QSettings("GNU Radio", "test_cpp_hb_qt_gui_workflow");
...
int main (int argc, char **argv) {
    ...
    test_cpp_hb_qt_gui_workflow* top_block = new test_cpp_hb_qt_gui_workflow();
...
#include "moc_test_cpp_hb_qt_gui_workflow.cpp"
