...
class Param(CoreParam):
    ...
    def get_input(self, *args, **kwargs):
        ...
        if dtype in ('file_open', 'file_save'):
            input_widget_cls = param_widgets.FileParam

        elif dtype == 'dir_select':
            input_widget_cls = param_widgets.DirectoryParam

        elif dtype == 'enum':
            input_widget_cls = param_widgets.EnumParam

        elif self.options:
            input_widget_cls = param_widgets.EnumEntryParam

        elif dtype == '_multiline':
            input_widget_cls = param_widgets.MultiLineEntryParam

        elif dtype == '_multiline_python_external':
            input_widget_cls = param_widgets.PythonEditorParam

        else:
            input_widget_cls = param_widgets.EntryParam
